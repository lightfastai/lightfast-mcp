...
3. Click **Install** and navigate to the Lightfast MCP folder
4. Select `lightfast_blender_addon.py` from the `addons` directory
5. Enable the addon by checking the box next to "AI: Lightfast MCP"

![Blender addon installation](/images/blender_addon_install.svg)

### Step 3: Access the Lightfast Panel
...
![Lightfast panel in Blender](/images/blender_panel.svg)
...
### Step 5: Start Blender and Claude
