...
async def stop_websocket_server(ctx: Context) -> Dict[str, Any]:
    """
    Stop the WebSocket server if it's running.

    Returns the result of the stop operation.
    """
    logger.info("Received request to stop WebSocket server.")
