...
from tools.ai.cli import app, async_chat, async_test, print_step_info
from tools.ai.multi_server_ai_client import Step, ToolCall, ToolResult
...
class TestClientsCLI:
    ...
    @patch("tools.ai.cli.load_server_configs")
    @patch("tools.ai.cli.create_multi_server_client_from_config")
    ...
    async def test_async_chat_with_servers(self, mock_create_client, mock_load_configs):
        ...
        with patch("tools.ai.cli.console.input", return_value="quit"):
